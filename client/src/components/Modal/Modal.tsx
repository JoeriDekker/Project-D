...
function Modal(props: Props) {
    return (
        <div className={"relative z-10 " + props.hiddenState} id="modal" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                        ...
                        <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                            <div className="sm:flex sm:items-start">
                                ...
                                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                    <h3 className="text-base font-semibold leading-6 text-gray-900" id="modal-title">{props.header}</h3>
                                    <div className="mt-2">
