...
function AnyButton2(props: Props) {
  return (
    <a
      href={props.link}
      className="ring-offset-background mt-8 focus-visible:ring-ring flex h-10 w-fit items-center justify-center whitespace-nowrap rounded-md bg-secondaryCol px-8 py-2 text-sm font-medium text-black transition-colors hover:bg-secondaryCol/70 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50"
      type="submit"
    >
      {props.text}
    </a>
...
function LinkLessButton(props: LinkLessButtonProps) {
  return (
    <button
      className="ring-offset-background mt-8 focus-visible:ring-ring flex h-10 w-fit items-center justify-center whitespace-nowrap rounded-md bg-secondaryCol px-8 py-2 text-sm font-medium text-black transition-colors hover:bg-secondaryCol/70 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50"
      type="submit"
